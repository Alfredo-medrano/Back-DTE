    ...
    try {
        ...
        if (!circuitBreaker.puedeEjecutar('HACIENDA_MH') || emisorConCredenciales.contingenciaManual) {
            ...
            const dteCreado = await dteRepository.crear({
                ...
                totales: {
                    ...
                    totalIva: contRes.documentoDTE.resumen.totalIva,
                    tributos: contRes.documentoDTE.resumen.tributos || null,
        ...
        const dteCreado = await dteRepository.crear({
            ...
            totales: {
                ...
                totalIva: documentoDTE.resumen.totalIva,
                tributos: documentoDTE.resumen.tributos || null,
